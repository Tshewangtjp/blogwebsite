...
$query = "SELECT service_id, title FROM services WHERE ORDER BY service_id DESC";
...
if(isset($_GET['page_no']) && $_GET['page_no'] != ""){
  ...
  $stmt1 = $connection->prepare("SELECT COUNT(*) As total_records FROM services");
  ...
  $stmt2 = $connection->prepare("SELECT * FROM services LIMIT $offset,$total_records_per_page");
  $stmt2->execute();
...
<?php if(isset($_SESSION['add-service-success'])) : ?>
        ...
        <?php elseif(isset($_SESSION['edit-service'])) : ?>
        ...
        <?php elseif(isset($_SESSION['edit-service-success'])) : ?>
        <div class="alert_message success" style="text-align: center;">
            <p>
    ...
    <div class="container dashboard_container">
        ...
        <main>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $service['title'] ?></td>
                        <td><a href="<?= ROOT_URL ?>edit-services.php?service_id=<?= $service['service_id'] ?>" class="btn sm">Edit</a></td>
                        <td><a href="<?= ROOT_URL ?>delete-services.php?service_id=<?= $service['service_id'] ?>" class="btn danger">Delete</a></td>
                    </tr>
                    <?php endwhile ?>
                </tbody>
            </table>
      ...
      <?php else : ?>
                <div class="alert_message error"><?= "No services found" ?></div>
                <?php endif ?>
        </main>
    </div>
</section>
