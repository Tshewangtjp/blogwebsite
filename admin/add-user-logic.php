...
//redirect back to signup page
    if(isset($_SESSION['add-user'])) {
        ...
        $insert_user_query = "INSERT INTO users SET fullname='$name', username='$username', email='$email', password='$hashed_password', avatar='$avatar_name', is_admin='$is_admin'";
        $insert_user_result = mysqli_query($connection, $insert_user_query);
        if(!mysqli_errno($connection)) {
            //redirect to login page
            $_SESSION['add-user-success'] = "New User $name added successfully";
