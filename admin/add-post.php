...
<section class="form_section">
    <div class="container form_section-container">
        ...
        <?php endif ?>
        <form action="<?= ROOT_URL ?>add-post-logic.php" class="admin_form" enctype="multipart/form-data" method="POST">
            <input type="text" name="title" value="<?= $title ?>" placeholder="Title Of The Post">
            ...
            <textarea id="editor" rows="10" name="body"><?= $body?></textarea>
