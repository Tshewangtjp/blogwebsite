...
if(isset($_GET['search']) && isset($_GET['submit'])) {
    ...
    $_SESSION['search-message'] = "$title have been found";
    die();
}
...
<br>
<br>
<?php if (isset($_SESSION['search-message'])): ?> 
            <div class="alert_message success">
            <p><?= $_SESSION['search-message']; 
            unset($_SESSION['search-message']);
            ?></p>
        </div>
        <?php endif ?>
<?php if(mysqli_num_rows($posts) > 0) : ?>
<section class="posts  section__extra_margin">
